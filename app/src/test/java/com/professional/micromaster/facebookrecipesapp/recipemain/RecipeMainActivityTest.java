...
import com.professional.micromaster.facebookrecipesapp.support.ShadowImageView;
...
public class RecipeMainActivityTest extends BaseTest {
    ...
    @Test
    public void testOnActivityCreate_getNextRecipe() throws Exception {
    ...
    public void testLogoutMenuClicked_ShouldLaunchLoginActivity() throws Exception {
        ...
        Intent intent = new ShadowActivity().peekNextStartedActivity();
        assertEquals(new ComponentName(activity, LoginActivity.class), intent.getComponent());
    }

    @Test
    public void testLisMenuClicked_ShouldLaunchRecipeListActivity() throws Exception {
