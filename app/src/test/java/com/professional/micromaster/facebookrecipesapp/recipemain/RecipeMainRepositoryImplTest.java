...
public class RecipeMainRepositoryImplTest extends BaseTest {
    ...
    public void testGetNextRecipeCalled_APIServiceSuccessCall_EventPosted() throws Exception {
        ...
        when(service.search(BuildConfig.FOOD_API_KEY, RecipeMainRepository.RECENT_SORT, RecipeMainRepository.COUNT, recipePage)).thenReturn(builCall(true, null));
    ...
    public void testGetNextRecipeCalled_APIServiceFailedCall_EventPosted() throws Exception {
        ...
        int recipePage = new Random().nextInt(RecipeMainRepository.RECIPE_RANGE);
        when(service.search(BuildConfig.FOOD_API_KEY, RecipeMainRepository.RECENT_SORT, RecipeMainRepository.COUNT, recipePage)).thenReturn(builCall(false, errorMsg));
        repository.setRecipePage(recipePage);
        repository.getNextRecipe();
    ...
    private Call<RecipeSearchResponse> builCall(final boolean success, final String errorMsg) {
